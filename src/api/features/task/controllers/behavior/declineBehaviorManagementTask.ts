...
export default function declineBehaviorManagementTask(req:Request, res:Response) {
    ...
    validateDeclineBehaviorManagementTaskRequest(requestData)
    .then((data)=> {
        ...
        .then((declinedTask)=> {
            ...
            .then((foundTask)=> {
                console.log("Behavior management check task declined successfully");
...
export function validateDeclineBehaviorManagementTaskRequest(data:IDeclineBehaviorManagementTaskRequest) {
    return new Promise<IDeclineBehaviorManagementTaskRequest>((resolve, reject)=> {
        ...
        if(!data.note) reject({ code:401, message:"Decline note parameter must be provided" });
